...
public class BusinessEntityDebtorServiceImp implements BusinessEntityDebtorService {
    ...
    public String  exportTxt() {
        ...
        List<BusinessEntityDebtorEntity> ada = businessEntityDebtorDao.findAll();
            String judul = "0103.600816."+years.format(date)+"."+month.format(date)+".D02.1.txt";

            pathExcelTxt(judul, ada);
            return judul;
    }
    public void pathExcelTxt(String fileName, List<BusinessEntityDebtorEntity> list) {
            ...
            if(list != null) {
                ...
                for (BusinessEntityDebtorEntity BusinessEntityDebtorEntity : list) {
                    ...
                    String datas = setValidationAndSetUpDatas(BusinessEntityDebtorEntity, lineUp) + "\n";
    ...
    public String setValidationAndSetUpDatas(BusinessEntityDebtorEntity entity, String lineUp){
        String FLG_DTL = "",
                CIF = "",
        ...
        if (entity.getFlgDtl()!= null){
            FLG_DTL = entity.getFlgDtl();
        }if (entity.getCif() != null){
            CIF = entity.getCif();
        }if(entity.getBussEntityIdNumber() != null){
            BUSS_ENTITY_ID_NUMBER = entity.getBussEntityIdNumber();
        }if(entity.getBussEntityName() != null){
            BUSS_ENTITY_NAME = entity.getBussEntityName();
        }if(entity.getBussEntityTypeCode() != null){
            BUSS_ENTITY_TYPE_CODE = entity.getBussEntityTypeCode();
        }if(entity.getPlaceOfEstablishment() != null){
            PLACE_OF_ESTABLISHMENT = entity.getPlaceOfEstablishment();
        }if (entity.getEstablishmentDeedDate()!=null){
            ESTABLISHMENT_DEED_DATE = iob.format(entity.getEstablishmentDeedDate());
        }if(entity.getLastAmendmentNumber()!=null){
            LAST_AMENDMENT_DEED_NUMBER = entity.getLastAmendmentNumber();
        }if (entity.getLastAmendmentDate()!=null){
            LAST_AMENDMENT_DEED_DATE = iob.format(entity.getLastAmendmentDate());
            ...
            BUSINESS_FIELD_CODE = entity.getBusinessFieldCode();
        }if (entity.getRelationReporterCode()!=null){
            RELATION_REPORTER_CODE = entity.getRelationReporterCode();
            ...
            GO_PUBLIC = entity.getGoPublic();
        }if (entity.getDebtorGroupCode()!=null){
            DEBTOR_GROUP_CODE = entity.getDebtorGroupCode();
        }if(entity.getDebtorRating() !=null){
            DEBTOR_RATING = entity.getDebtorRating();
        }if(entity.getRatingAgency() != null){
            RATING_AGENCY = entity.getRatingAgency();
        }if(entity.getRatingDate()!=null){
            RATING_DATE = iob.format(entity.getRatingDate());
        }if(entity.getDebtorGroupName()!=null){
            DEBTOR_GROUP_NAME = entity.getDebtorGroupName();
        }
        if (entity.getBranchOfficeCode() != null) {
            BRANCH_OFFICE_CODE = entity.getBranchOfficeCode();
